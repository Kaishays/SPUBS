...
* **Sentences Table (e.g., `pdf_sentences`)**
    * Sentences are stored character-by-character.
...
* **Embeddings Table (e.g., `all-minilm-l6-v2`)**
    * Stores the 384-dimensional vectors generated by the BERT model. Similar to the sentences, the vectors are broken down and stored float-by-float.
